...
const CONFIG = {
  ...
  // Lowered from 210000: Cloudflare Workers on the free plan have a tight
  // per-request CPU-time budget. 210k PBKDF2 rounds plus 5 recovery-code
  // hashes reliably blew that budget and crashed signup with a generic
  // "Unexpected server error." 120k is still a solid, modern iteration
  // count for PBKDF2-SHA256 and comfortably fits the CPU budget.
